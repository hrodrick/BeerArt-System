    ...
    <body background="<?=DIR.URL_IMG.$imagen;?>">      
        <div id="wrapper">
            ...
            <div class="container">
              <h2 class="t_blanco">&nbsp;Alta de Personal</h2>
              <p>&nbsp;</p>
              <div class="contenedor div_trans5">
                   <form class="form-horizontal" action="<?=DIR?>Usuario/nuevo" method="post" name="form">
                              ...
                              <div class="col-xs-9">
                                   <input class="form-control" type="password" name="contra" placeholder="Ingrese Constrase&ntilde;a" required>
                                   <p>&nbsp;</p>
                              </div>
                              ...
                              <div class="col-xs-9">
                                    <select name="idRol" class="form-control" id="select">
                                      ...
                                      foreach ($roles as $value) {
                                          echo '<option value='.$value->getId().'>'.$value->getRol().'</option>';
                                      }?>
                                    </select>
                                    <p>&nbsp;</p>
                              </div>
