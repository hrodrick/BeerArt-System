		           ...
		           <table class="table">
		              <thead>
		                  <tr>
		                     ...
		                     <th width="4%"></th>
		                     <th width="4%"></th>		                     
		                     <th width="15%"><a href="<?=DIR?>Usuario/reorder/<?= $page;?>/idRol/<?= ($campo!='idRol')?'asc':ver_orden($orden);?>" class="t_blanco_link" data-toggle="tooltip" data-html="true"  title="Ordenar por Usuario orden <?php echo ver_orden($orden);?>">Rol<?php if ($campo=='idRol') {?>&nbsp;<img src="<?php echo $img;?>" border="0"><?php }?></a></th>
		                     <th width="15%"><a href="<?=DIR?>Usuario/reorder/<?= $page;?>/nombre/<?= ($campo!='nombre')?'asc':ver_orden($orden);?>" class="t_blanco_link" data-toggle="tooltip" data-html="true"  title="Ordenar por Usuario orden <?php echo ver_orden($orden);?>">Nombre<?php if ($campo=='nombre') {?>&nbsp;<img src="<?php echo $img;?>" border="0"><?php }?></a></th>
 							 <th width="15%""><a href="<?=DIR?>Usuario/reorder/<?= $page;?>/apellido/<?= ($campo!='apellido')?'asc':ver_orden($orden);?>" class="t_blanco_link" data-toggle="tooltip" data-html="true"  title="Ordenar por Apellido orden <?php echo ver_orden($orden);?>">Apellido<?php if ($campo=='apellido') {?>&nbsp;<img src="<?php echo $img;?>" border="0"><?php }?></a></th>		                     
 							 <th width="15%" align="right"><a href="<?=DIR?>Usuario/reorder/<?= $page;?>/domicilio/<?= ($campo!='domicilio')?'asc':ver_orden($orden);?>" class="t_blanco_link" data-toggle="tooltip" data-html="true"  title="Ordenar por Telefono orden <?php echo ver_orden($orden);?>">Domicilio<?php if ($campo=='domicilio') {?>&nbsp;<img src="<?php echo $img;?>" border="0"><?php }?></a></th>		                     
		              ...
		              <tbody>
		                      ...
		                      <div class="modal-dialog">
		                          <div class="modal-content">
		                               ...
		                               <div class="modal-body">
		                                    ...
		                                    <h5><?php echo $valor->getIdRol()->getRol();?></h5>
		                 ...
		                 <tr>
		                     ...
		                     <td><a href="<?=DIR?>Usuario/edit/<?= urlencode(base64_encode($valor->getId()));?>/<?= $page;?>/<?= $campo;?>/<?= $orden;?>" class="t_blanco_link" data-toggle="tooltip" title="Modificar <?=$valor->getNombre()?> <?=$valor->getApellido()?>"><?=$valor->getIdRol()->getRol();?></a></td>
