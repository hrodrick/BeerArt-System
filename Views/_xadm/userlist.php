		           ...
		           <table class="table">
		              <thead>
		                  <tr>
		                     ...
		                     <th width="4%"></th>
		                     <th width="4%"></th>		                     
		                     <th width="15%"><a href="<?=DIR?>Usuario/reorder/<?= $page;?>/rol/<?= ($campo!='rol')?'asc':ver_orden($orden);?>" class="t_blanco_link" data-toggle="tooltip" data-html="true"  title="Ordenar por Usuario orden <?php echo ver_orden($orden);?>">Rol<?php if ($campo=='rol') {?>&nbsp;<img src="<?php echo $img;?>" border="0"><?php }?></a></th>
