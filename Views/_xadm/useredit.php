    ...
    <body background="<?=DIR.URL_IMG.$imagen;?>">      
        <div id="wrapper">
            ...
            <div class="container">
              <h2 class="t_blanco">&nbsp;Modificaci&oacute;n de Personal</h2>
              <p>&nbsp;</p>
              <div class="contenedor div_trans5">
                   <form class="form-horizontal" action="<?=DIR?>Usuario/editado" method="post" name="form">
                              ...
                              <div class="col-xs-9">
                                    <select name="idRol" class="form-control" id="select">
                                      <?php
                                      foreach ($roles as $value) {
                                          $selected=($value->getId()==$obj->getIdRol())?'selected':'';
                                          echo '<option value='.$value->getId().' '.$selected.'>'.$value->getRol().'</option>';
                                      }?>
                                    </select>
                                    <p>&nbsp;</p>
                              </div>
                              ...
                              <div class="col-xs-12 text-center">                  
                                  ...
                                  <input type="hidden" name="emailOld" value="<?=$obj->getEmail()?>">
