  ...
  <div class="container-fluid div_trans8">
    <header>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);" data-toggle="tooltip" title="Listados de Ventas">Ventas <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="<?=DIR?>Ventas/litrosVendidosEntreFechas" data-toggle="tooltip" title="Listado de Litros por Cerveza">Litros Vendidos por Cerveza</a></li>      
          </ul>
        </li> 
