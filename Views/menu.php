...
<nav class="navbar navbar-inverse" style="margin-top:6px;">
  <div class="container-fluid div_trans8">
    <header>
      ...
      ?>
                     <div id="MisDatos<?= $_SESSION['cliente']->getId();?>" class="modal fade" role="dialog">
                          <div class="modal-dialog modal-sm">
                              <div class="modal-content">
                                   ...
                                   <div class="modal-body">
                                        <h4><?php echo $_SESSION['cliente']->getNombre().' '.$_SESSION['cliente']->getApellido();?></h4>
                                        <h5><?php echo $_SESSION['cliente']->getDomicilio();?></h5>
                                        <h5><?php echo $_SESSION['cliente']->getLocalidad();?></h5>                                                          
                                        <h5><?php echo $_SESSION['cliente']->getTelefono();?></h5>                                                         
      ...
      ?>
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);" data-toggle="tooltip" title=""><span class="glyphicon glyphicon-user"></span> <?=$_SESSION['cliente']->getNombre().' '.$_SESSION['cliente']->getApellido()?> <span class="caret"></span></a>
          <ul class="dropdown-menu">        
            <li><a data-toggle="modal" href="#MisDatos<?= $_SESSION['cliente']->getId();?>" data-toggle="tooltip" title="Ver Mis Datos"><span class="glyphicon glyphicon-user"></span> Mis Datos</a></li>
