        ...
        <div id="wrapper">
            ...
            <div class="container">
              ...
              <div class="contenedor div_trans5">
                   <form class="form-horizontal" action="<?=DIR?>Front/sendContacto" method="post" name="form">
                              <p>&nbsp;</p>
                              ...
                              <div class="col-xs-9">
                                   <input class="form-control" type="text" name="email" value="<?=$email;?>" placeholder="Ingrese su E-Mail" autofocus required>
                                   <p>&nbsp;</p>
                              </div>
