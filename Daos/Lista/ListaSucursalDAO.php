...
class ListaSucursalDAO extends SingletonAbstractDAO implements iDao{

	use tListaDAO;

	function __construct(){
		$this->session='Sucursales';		
	   		...
	   		switch ($campo) {
	   			case 'id':
	        		$aux[$key] = $obj->getId();
	   				break;
	   			case 'nombre':
	        		$aux[$key] = $obj->getNombre();
	   				break;
	   			case 'domicilio':
	        		$aux[$key] = $obj->getDomicilio();
	   				break;	 
	   			case 'localidad':
	        		$aux[$key] = $obj->getLocalidad();
	   				break;	   				
	   			case 'telefono':
	        		$aux[$key] = $obj->getTelefono();
	   				break;	   
	   			case 'standBy':
