...
class DBUsuarioDAO extends SingletonAbstractDAO implements iDao{
	...
	function buscarEmail($email){
		$obj='';
		$query = 'SELECT * FROM '.$this->table.' WHERE idRol != 0 AND email='.'"'.$email.'"';
